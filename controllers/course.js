...
const  uploadImage = async (req, res) => {
  ...
  const updateLesson=async(req,res)=>{
    ...
    res.json({ok:true})
    return res.status(400)('update lesson failed')
  ...
  const publishCourse=async(req,res)=>{
    try {
      ...
      console.log(error)
      return res.status(400).send('Publish coure failed')
  ...
  const unpublishCourse=async(req,res)=>{
    try {
      ...
      console.log(error)
      return res.status(400).send('UnPublish coure failed')
  ...
  const freeEnrollment=async(req,res)=>{
    try{
      ...
      res.json({message:'Congrajulations,you have successfully enrolled for the course',
    course:course
    })
  ...
  const listIncomplete=async(req,res)=>{
...
module.exports={uploadImage,removeImage,create,read,
  uploadVideo,removeVideo,addLesson,update,
  removeLesson,updateLesson,publishCourse,unpublishCourse,
  courses,checkEnrollment,freeEnrollment,paidEnrollment,
  stripeSuccess,userCourses,markCompleted,listCompleted,listIncomplete,studentCount}